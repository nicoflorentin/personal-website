...
const Project = ({ title, description, image, githubURL, deployURL }) => {
	return (
		<div className="flex flex-col gap-3 text-center px-5 my-3 m-auto max-w-xs border-r-2 border-bone md:max-w-full md:flex-row items-center">
			...
			<img src={image} alt="projectImage" className="object-cover h-36 w-44 rounded-sm md:rounded-none md:order-1" />
			<div className="flex justify-center items-center gap-6 mt-1 font-semibold md:order-2">
