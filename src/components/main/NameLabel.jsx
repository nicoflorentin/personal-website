...
const NameLabel = () => {
	...
	return (
		<div className="text-primary max-[370px]:pl-2">
			<h1 className="text-[16px] tracking-wide pl-1 sm:pl-2 font-inter">NICOLÁS FLORENTÍN</h1>
			<h2 className="font-rubik leading-[0.95em] md:tracking-[5px] mb-20 text-[80px] max-[370px]:text-[70px]">
				FRONT<br className='md:hidden' />END <br /> DEV{barIsVisible ? '' : '/'}
			</h2>
